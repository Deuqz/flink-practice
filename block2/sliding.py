...
def python_data_stream_example():
    ...
    checkpoint_config.set_checkpoint_storage(FileSystemCheckpointStorage('hdfs://namenode:9870/flink/checkpoints'))
    ...
    ds.window_all(SlidingProcessingTimeWindows.of(size=Time.seconds(10), slide=Time.seconds(10))) \
...
class TemperatureReducer(ReduceFunction):
    ...
    def reduce(self, a, b):
        return max(a, b, key=lambda x: x.temperature)
